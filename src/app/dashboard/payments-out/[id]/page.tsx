...
export default function PaymentOutDetailPage({ params }: { params: Promise<{ id: string }> }) {
    ...
    const handleShare = async () => {
        try {
            ...
            const file = new File([blob], `Voucher_${payment.payment_number}.pdf`, { type: 'application/pdf' })
            ...
            if (navigator.share && navigator.canShare({ files: [file] })) {
                ...
                a.href = url
                a.download = `Voucher_${payment.payment_number}.pdf`
                a.click()
    ...
    const getModeIcon = (mode: string) => {
        switch (mode?.toLowerCase()) {
            ...
            default: return <Wallet className="text-red-500" />
        }
    }
        ...
        <div className="max-w-4xl mx-auto space-y-10 pb-20 animate-in fade-in duration-500">
            ...
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6">
                ...
                <div className="flex gap-3">
                    ...
                    <Button
                        variant="outline"
                        onClick={() => router.push(`/dashboard/payments-out/create?edit=${resolvedParams.id}`)}
            ...
            <div id="voucher-content" className="grid grid-cols-1 md:grid-cols-3 gap-8 bg-inherit">
                <div className="md:col-span-2 space-y-8">
                    ...
                    <Card className="bg-slate-900 text-white p-10 lg:p-12 rounded-[40px] shadow-2xl overflow-hidden relative group">
                        ...
                        <p className="text-red-400 text-[10px] font-black uppercase tracking-widest mb-4">Total Amount Paid</p>
                        ...
                        <div className="mt-10 flex flex-wrap gap-6 pt-10 border-t border-white/10 uppercase font-black text-[10px] tracking-widest">
                            ...
                            <div className="flex items-center gap-2">
                                ...
                                <span className="text-red-400">{payment.payment_mode}</span>
                            </div>
                        </div>
                    </Card>
                                    ...
                                    <div className="space-y-4 flex-1">
                                        ...
                                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                            {(payment.billing_address || payment.customers?.billing_address) && (
                                                <div>
                                                    <p className="text-[9px] font-black uppercase tracking-widest text-slate-400 mb-1">Snapshot: Billing Address</p>
                                            ...
                                            {(payment.shipping_address || payment.customers?.shipping_address) && (
                                                <div>
                                                    <p className="text-[9px] font-black uppercase tracking-widest text-slate-400 mb-1">Snapshot: Shipping Address</p>
                        ...
                        <div className="space-y-6">
                            <div className="flex justify-between items-center group cursor-pointer">
                                <div className="flex items-center gap-3">
                                    ...
                                    <div>
                                        <p className="text-[9px] font-black text-slate-400 uppercase">Voucher No</p>
