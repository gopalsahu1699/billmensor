...
export default function PartyLedgerReport() {
  ...
  const exportToXLS = () => {
    const partyName =
      parties.find((p) => p.id === selectedParty)?.name || "Ledger";
    const headers = [
      "Date",
      "Type",
      "Document #",
  ...
  const handleShare = async () => {
    ...
    await sharePDF({
      ...
      title: "Party Ledger",
      text: `Attached is the ledger statement for ${partyName}.`
    });
  };
      ...
      <div className="flex items-center gap-4 no-print">
        ...
        <div>
          ...
          <p className="text-slate-500">
            View consolidated transaction history for customers or suppliers.
          </p>
        </div>
      </div>
          ...
          <Card>
            <CardHeader className="pb-2 text-center">
              ...
              <CardTitle className="text-2xl">
                ₹ {summary.totalBill.toLocaleString("en-IN")}
              </CardTitle>
            </CardHeader>
          </Card>
          <Card>
            <CardHeader className="pb-2 text-center text-green-600">
              <CardDescription className="text-green-600 opacity-60">
                Total Amount Paid
              </CardDescription>
              <CardTitle className="text-2xl">
              ...
              <tbody className="divide-y divide-slate-50">
                ...
                {ledger.length === 0 && !loading && (
                  <tr>
                    ...
                    >
                      Select a party to view their financial history.
                    </td>
                  </tr>
                )}
              </tbody>
